...
if (~exist('I_O\Qlambda','var'))
    
    load I_O\Qlambda.txt;
...
lake='Croche'; %Järven nimi
year=2015; %Mallinnuksen aloitusvuosi
m_start= [2015,5,14];%[2014,4,13]; %[2012,5,5]; %Mallinnuksen aloituspäivä [2013,5,11]
m_stop=[2022,12,31];  %Mallinnuksen lopetuspäivä
