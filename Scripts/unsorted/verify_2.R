...
ggsave("Data/Figures/presentations/cold_co2_o2_departures_v1.jpg", p58_1, dpi = 300, width = 7 , height = 6, units = "in")
...
ggsave("Data/Figures/presentations/16_co2_o2_departures_v1.jpg", p16_1, dpi = 300, width = 7 , height = 6, units = "in")
...
pal2_1 <- pal2 + theme(axis.text.x = element_text(size = 16), # Increase axis tick mark text size
                       ...
                       axis.title.y = element_text(size = 18))
pal2_1
ggsave("Data/Figures/presentations/hot_co2_o2_departures_v1.jpg", pal2_1, dpi = 300, width = 7 , height = 6, units = "in")
...
ggsave("Data/Figures/presentations/3_panel_co2_o2_departures_v1.jpg", grid, dpi = 300, width = 10, height = 5, units = "in")