#Hydrographs using era5 rain data
...
df = merge(df_era5, pheno[, c("doy_start", "doy_end", "year")],
                  by = "year")
...
df <- subset(df, period_rel_leaf_fall  == c("leaf_fall", "before_leaf_fall"))
...
pheno2 <- subset(pheno, year != c(2011, 2012, 2013, 2014, 2020))

#Create list
dfl <- split(df, df$year)
# dfln = split(df_era5, df_era5$year)

#Vector for xaxis (month and weeks)
month_tick <- as.numeric(strftime(c('2015-09-01','2015-10-01','2015-11-01'),'%j'))
month_label <- c('Sep','Oct','Nov')
week_tick <- as.numeric(strftime(c('2015-08-18','2015-08-25','2015-09-08', '2015-09-15','2015-09-22','2015-10-08','2015-10-15', '2015-10-22','2015-11-08','2015-11-15'), '%j'))

#Export graphic to pdf
pdf('Data/export/hydrographs_all_years_era5.pdf', height = 10)
...
#Export graphic to pdf
pdf('Data/export/hydrographs_all_years_era5_fixed.pdf', height = 10)
