...
# Load data
df <- read.csv("Data//Processed//boue//delta_co2-2_model_2015_2022_corrections.csv", header = TRUE)
...
#2015
p15 <- ggplot(df.list$'2015') +
  theme_annual +
  geom_vline(xintercept = pheno[pheno$year == 2015,'doy_start'],linetype = "dashed", linewidth = 1.5) +
  geom_vline(xintercept = pheno[pheno$year == 2015,'doy_end'],linetype = "dashed", linewidth = 1.5) +
  geom_line(aes(x = doy, y = co2), linewidth = 1.3, color = "#528fad") +
  geom_line(aes(x = doy, y = o2), linewidth = 1.3, color = "#528fad") +
  labs(title = 'a) 2015') 

#2016
p16 <- ggplot(df.list$'2016') +
  theme_annual +
  geom_vline(xintercept = pheno[pheno$year == 2016,'doy_start'],linetype = "dashed", linewidth = 1.5) +
  geom_vline(xintercept = pheno[pheno$year == 2016,'doy_end'],linetype = "dashed", linewidth = 1.5) +
  geom_line(aes(x = doy, y = co2), linewidth = 1.3, color = "#72bcd5") +
  geom_line(aes(x = doy, y = o2), linewidth = 1.3, color = "#72bcd5") +
  labs(title = 'b) 2016') 

#2017
p17 <- ggplot(df.list$'2017') +
  theme_annual +
  geom_vline(xintercept = pheno[pheno$year == 2017,'doy_start'],linetype = "dashed", linewidth = 1.5) +
  geom_vline(xintercept = pheno[pheno$year == 2017,'doy_end'],linetype = "dashed", linewidth = 1.5) +
  geom_line(aes(x = doy, y = co2), linewidth = 1.3, color = "#e76254") +
  geom_line(aes(x = doy, y = o2), linewidth = 1.3, color = "#e76254") +
  labs(title = 'c) 2017') 

#2018
p18 <- ggplot(df.list$'2018') +
  theme_annual +
  geom_vline(xintercept = pheno[pheno$year == 2018,'doy_start'],linetype = "dashed", linewidth = 1.5) +
  geom_vline(xintercept = pheno[pheno$year == 2018,'doy_end'],linetype = "dashed", linewidth = 1.5) +
  geom_line(aes(x = doy, y = co2), linewidth = 1.3, color = "#1e466e") +
  geom_line(aes(x = doy, y = o2), linewidth = 1.3, color = "#1e466e") +
  labs(title = 'd) 2018') 

#2019
p19 <- ggplot(df.list$'2019') +
  theme_annual +
  geom_vline(xintercept = pheno[pheno$year == 2019,'doy_start'],linetype = "dashed", linewidth = 1.5) +
  geom_vline(xintercept = pheno[pheno$year == 2019,'doy_end'],linetype = "dashed", linewidth = 1.5) +
  geom_line(aes(x = doy, y = co2), linewidth = 1.3, color = "#ffd06f" ) +
  geom_line(aes(x = doy, y = o2), linewidth = 1.3, color = "#ffd06f" ) +
  labs(title = 'e) 2019') 

#2021
p21 <- ggplot(df.list$'2021') +
  theme_annual +
  geom_vline(xintercept = pheno[pheno$year == 2021,'doy_start'],linetype = "dashed", linewidth = 1.5) +
  geom_vline(xintercept = pheno[pheno$year == 2021,'doy_end'],linetype = "dashed", linewidth = 1.5) +
  geom_line(aes(x = doy, y = co2), linewidth = 1.3, color = "#ef8a47") +
  geom_line(aes(x = doy, y = o2), linewidth = 1.3, color = "#ef8a47") +
  labs(title = 'f) 2021') 

#2022
p22 <- ggplot(df.list$'2022') +
  theme_annual +
  geom_vline(xintercept = pheno[pheno$year == 2022,'doy_start'],linetype = "dashed", linewidth = 1.5) +
  geom_vline(xintercept = pheno[pheno$year == 2022,'doy_end'],linetype = "dashed", linewidth = 1.5) +
  geom_line(aes(x = doy, y = co2), linewidth = 1.3, color = "#f7aa58") +
  geom_line(aes(x = doy, y = o2), linewidth = 1.3, color = "#f7aa58") +
  labs(title = 'g) 2022') 

#Visualize the panels
plot_grid(p15,p16,p17,p18,p19,p21,p22,nrow = 3)
#You could add regression if you want, but here is an alternative
...
# Load data 
df_1 <- read.csv("Data/Processed/combined/comp_years.csv", header = TRUE)
lf <- read.csv("Data/Processed/lake/co2_o2_post_lf_2022_corrections.csv", header = TRUE)
...
ggsave("Data/Figures/comments/co2_o2_all_years_2022_corrections.jpg",grid, dpi = 600, width = 10, height = 6)
