...
lf <- read.csv("Data/Processed/lake/co2_o2_post_lf_2022_corrections.csv")
...
write.csv(metrics_all_years, "Data/Processed/combined/metrics_all_years_2022_corrected.csv")
