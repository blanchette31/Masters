...
# Load data
df <- read.csv("Data/Processed/comments/comp_years_V2_with_rad_fall_per_day.csv", header = TRUE, row.names = 1)
...
ggsave("Data/Figures/comments/PCA_rad_per_day.jpg", p2, dpi = 300, height = 6, width = 10, units = "in")
...
ggsave("Data/Figures/comments/PCA_rad_per_day_no_labels.jpg", p3, dpi = 300, height = 6, width = 10, units = "in")
