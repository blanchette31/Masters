...
# load data
df <- read.csv("Data/Processed/lake/co2_o2_post_lf_2022_corrections.csv", header = TRUE)
...
write.csv(results, "Data/Processed/comments/slopes_vs_hypothetical_2022_corrections.csv")