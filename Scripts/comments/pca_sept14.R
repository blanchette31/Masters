...
# Load data
df <- read.csv("Data/Processed/comments/comp_years_sept14_2022.csv", header = TRUE, row.names = 1)
...
p2
 ...
 ggsave("Data/Figures/comments/PCAsept14_no_formatting_2022.jpg", p2, dpi = 300, height = 6, width = 10, units = "in")
...
ggsave("Data/Figures/comments/PCA_sept14_2022.jpg", p3, dpi = 300, height = 6, width = 10, units = "in")
