...
ggsave("Data/Figures/PCA_no_lf_duration_V2.jpg", p2, dpi = 300, height = 6, width = 10, units = "in")
...
ggsave("Data/Figures/PCA_no_lf_duration_V3.jpg", p3, dpi = 300, height = 6, width = 10, units = "in")
