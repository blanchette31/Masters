...
function plot_mod_vs_obs_CRO_2021_singlerun_v1(figno,m_start,m_stop,tt,Tzt,Kz_ak,Kz_ak_ice,Kz_N0,C_shelter,alb_melt_ice,alb_melt_snow,swa_b0,swa_b1)

clf;

% *** to be specified before runnning ***

obstemfile = 'CRO_obstemp_daily_alldepths_2016_2021.txt'; % file temperature observations
...
mintime = [2021  5  1  0  0  0];
maxtime = [2022 1 1  0  0  0];
mintem =  0.0;
maxtem =  30.0;
